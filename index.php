...
<body>
					...
					foreach ($products as $index => $product) {
						...
						<input class="Buy" type="submit" name="submit" value="Buy">
							...
							<div class="product-pic">
								<a href="DetailProduct.php?id=' . $product['id'] . '"><img src="' . $product['image'] . '" title="product-name" /></a>
								<p>
	...
	<li style=" position: absolute; top: -18px; right: 250px; width:25px">
		<a style="cursor: pointer; display: flex;justify-content: center;" class="cart" href="cartshoe.php">
			<img src="./images/images-removebg-preview.png" alt="">
			<span id="clickme"></span>
			<p id="aa" style="display: inline; color:red;align-items: baseline; font-size:20px "><?php Appear() ?></p>
		</a>
	</li>
	<!---- start-bottom-grids---->
